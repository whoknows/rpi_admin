...
$(document).ready(function() {
	...
	$('.navi > li').each(function(){
		...
		if($a.attr('href').split('=')[1] === $('input[name=current_page]').val()){
...
$('.info-toggle-button').toggleButtons({style: {enabled: "info"}});
